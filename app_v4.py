...
st.markdown("""
<div style="border: 2px solid #667eea; border-radius: 10px; padding: 1rem; background-color: #f0f8ff; text-align: center;">
    <h3>📊 Panel de Clima en Grafana</h3>
    <p>Haz clic en el siguiente enlace para ver el panel completo:</p>
    <a href="https://nanaquintana21.grafana.net/public-dashboards/35e7b48778fb40ffabb2f07b7be264d4" target="_blank" style="font-size: 18px; color: #4e5ae8; font-weight: bold;">
        🌐 Abrir Panel de Grafana
    </a>
</div>
""", unsafe_allow_html=True)
